...
export function normalizeClientMapLayer(layer = {}) {
  ...
  return {
    ...
    visible: layer.visible === true || safeLayer.default_visible === true || metadata.defaultVisible === true || metadata.default_visible === true,
...
export function toSecureMapLayer(layer = {}) {
  ...
  return {
    ...
    visible: Boolean(normalized.visible) && normalized.available !== false && normalized.is_active !== false && isLayerReady(normalized),
    defaultVisible: Boolean(normalized.visible) && normalized.available !== false && normalized.is_active !== false && isLayerReady(normalized),
